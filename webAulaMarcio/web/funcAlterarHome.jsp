<%-- 
    Document   : funcAlterarHome
    Created on : 16 de set. de 2024, 07:32:00
...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="funcAlterar.jsp">

            <div class="form-group">
                <label for="idFunc">Identificação do Funcionário a Alterar</label>
                <input type="number" id="idFunc" name="idFunc" class="form-control" placeholder="Identificação:">

                <label for="nomeFunc">Nome do Funcionario a Alterar</label>
                <input type="text" id="nomeFunc" name="nomeFunc" class="form-control" placeholder="Nome:">

                <label for="idDepto">Departamento do Funcionario a Alterar</label>
                <input type="number" id="idDepto" name="idDepto" class="form-control" placeholder="Departamendo:">

                <label for="salHora">Salario Hora do Funcionario a Alterar</label>
                <input type="number" id="salHora" name="salHora" class="form-control" placeholder="Salario Hora:">
            </div>
