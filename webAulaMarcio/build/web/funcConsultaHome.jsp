<%-- 
    Document   : funcConsultaHome
    Created on : 16 de set. de 2024, 07:55:10
...
<body>
    ...
    <div class="container mt-4">
        ...
        <h1 style="margin-bottom: 30px">Consulta</h1>
        <form action="funcConsulta.jsp">

            <div class="form-group">
                <label for="idFunc">Identificação do Funcionário a Consultar</label>
