<%-- 
    Document   : funcCadastraHome
    Created on : 16 de set. de 2024, 07:54:39
...
<body>
    ...
    <div class="container mt-4">
        ...
        <h1 style="margin-bottom: 30px">Cadastrar</h1>
        <form action="funcCadastra.jsp">

            <div class="form-group">

                <label for="nomeFunc">Nome do Funcionario a Cadastrar </label>
                <input type="text" id="nomeFunc" name="nomeFunc" class="form-control" placeholder="Nome:">

                <label for="idDepto">Departamento do Funcionario a Cadastrar</label>
                <input type="number" id="idDepto" name="idDepto" class="form-control" placeholder="Departamendo:">

                <label for="salHora">Salario Hora do Funcionario a Cadastrar</label>
